...
/******/ 	var hotCurrentHash = "48988ea51eed2b2fba84"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _welcomeJs = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Test = (function (_Component) {
	    ...
	    Test.prototype.handleClick = function handleClick() {
	        ...
	        var fetchUrl = 'http://api.github.com/users/iwfe';
	        var local = 'test.json';
	        /**
	         * 请选择任意一种网络请求方式
	         */
	        $.ajax({
	            ...
	            error: function error() {
	                _this.setState({ clickHint: 'ie8无法访问api.github.com' });
	            }
	        });
	        fetch(local, { method: 'GET' }).then(function (response) {
	    ...
	    Test.prototype.render = function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _fetch ? _react2['default'].createElement(
	                'div',
	                { className: 'info' },
	                _fetch
	            ) : null
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    function lib$es6$promise$asap$$attemptVertx() {
	      try {
	        var r = require;
	        var vertx = __webpack_require__(164);
	    ...
	    */
	    ...
	    if ("function" === 'function' && __webpack_require__(165)['amd']) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7), (function() { return this; }()), __webpack_require__(163)(module)))
